        ...
        return (
            <div className="container">
                ...
                <div className="row row-content align-items-center">
                    ...
                    <h2 className="underline">My Address</h2>
                        <address>
                            171 Brook st<br />
                            San Luis Obispo,
                            California, CA 93401<br />
                            U.S.A.
                        </address>
                    </div>
                    <div className="col">
                        <a role="button" className="btn btn-link" href="tel:+18058199999"><i className="fa fa-phone" /> 1-805-819-9999</a><br />
                        <a role="button" className="btn btn-link" href="mailto:itIsreal@gmail.com"><i className="fa fa-envelope-o" /> desiemeng21m@gmail.com</a>
                    </div>
                </div>
                ...
                <div className="row row-content">
                    ...
                    <div className="col-md-10">
                        <Form onSubmit={this.handleSubmit}>
                            ...
                            <FormGroup row>
                                <Label htmlFor="feedback" md={2}>Comments</Label>
                                <Col md={10}>
